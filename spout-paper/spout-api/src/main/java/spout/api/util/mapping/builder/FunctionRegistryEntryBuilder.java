 ...
 */
public interface FunctionRegistryEntryBuilder<T> extends FunctionRegistryEntry<T> {

    /**
     * Sets the function that is applied for this mapping.
     *
     * <p>
     * If set, the mapping will ignore any direct {@link ToRegistryEntryBuilder#setTo} set.
     * </p>
     *
     * <p>
     * Function mappings are much less efficient than simple mappings.
     * Please use simple mappings ({@link ToRegistryEntryBuilder#setTo}) whenever you can.
     * </p>
     *
     * <p>
